...
class Auto (CommandGroup):
	...
	def __init__ (self):
		...
		self.addSequential(MoveClawFor(seconds=1.5, power=-0.5))
		# self.addSequential(Observe())

		self.addSequential(DriveFor(seconds=2.5, direction=(-0.7, 0)))
		...
		# 	self.addSequential(MoveArmFor(seconds=1.5, power=1))
		# 	self.addSequential(MoveClawFor(seconds=1.5, power=0.5))
		...
		# 	self.addSequential(Align())
		# 	self.addSequential(MoveArmFor(seconds=1.5, power=1))
		# 	self.addSequential(MoveClawFor(seconds=1.2, power=0.5))
